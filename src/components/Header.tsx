...
const Header = () => {
  ...
  return (
    <header 
      ...
      style={{ backgroundColor: scrolled ? 'white' : 'transparent', height: '100px' }}
    >
  ...
  {!scrolled && <div className="absolute inset-0 backdrop-blur-md" style={{ zIndex: -1, opacity: 1}}></div>}
      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4 lg:px-8 h-full flex items-center pt-4">
          <div className="flex h-full w-full items-center justify-between">
            ...
            <div className="flex-1 flex justify-start -ml-4 md:-ml-6 lg:-ml-8">
              <Link href="/" className="flex-shrink-0">
                <Image 
                  ...
                  width={150}
                  height={80}
                  className="h-16 md:h-[72px] lg:h-20 w-auto transition-all duration-300"
                  priority
                />
              </Link>
            </div>
            ...
            <div className="hidden md:flex flex-1 justify-end items-center space-x-3 lg:space-x-6">
              <a href="tel:+1234567890" className="flex items-center text-white hover:text-white/80 transition-colors">
                <svg className="w-4 h-4 md:w-5 md:h-5 mr-1 lg:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                <span className="font-medium text-xs md:text-sm lg:text-base">+1 (234) 567-890</span>
              </a>
